        ...
        <Form inline>
          <Form-item>
            ...
            <Input class="search_item" type="text" v-model="searchList.searchCondition.goodsDesc" clearable
              placeholder="商品标题"></Input>
            <Select clearable placeholder="商品状态" @on-change="searchManage"
          ...
          <Modal title="查看订单详情" width="55" :styles="{top: '70px'}" v-model="viewData.modalDetail">
            <div class="order_info">
              <h3>商品信息</h3>
              <Row>
                <Col span="10">商品id: {{viewData.Detail.goodsId}}</Col>
                <Col span="10">状态: {{viewData.Detail.goodsStatusChina}}</Col>
              </Row>
              <h4>订单标题: {{viewData.Detail.goodsDesc}}</h4>
              <Row>
